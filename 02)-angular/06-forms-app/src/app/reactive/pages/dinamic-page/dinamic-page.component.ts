...
// https://www.udemy.com/course/angular-fernando-herrera/learn/lecture/37405954#overview
// https://v16.angular.io/guide/reactive-forms
  ...
  isValidFieldInArray( formArray: FormArray, index: number ) {
    return this._validatorService.isValidFieldInArray(formArray, index)
  }
  ...
  onAddToFavorites():void {
    /* este input esta afuera del control de formulario principal por lo que es un formControl*/
